...
class LocationService(private val context: Activity) : Service(), LocationListener,
    ...
    private fun requestLocationUpdates() {
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            } //else DialogUtil.showYesNoButton(context, R.string.PermissionLocationTitle, context.getString(R.string.enable_location_services)) { _: DialogInterface?, _: Int -> openLocationSettings() }
